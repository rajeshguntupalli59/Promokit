...
export default function SignupPage() {
  ...
  return (
    ...
    >
      <div
        className="orb w-96 h-96 pointer-events-none"
        style={{
        ...
        >
          {success ? (
            <div className="text-center py-8">
              ...
              >
                <svg width="28" height="28" fill="none" viewBox="0 0 24 24" stroke="#22C55E">
              ...
              <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '15px', lineHeight: 1.6 }}>
                We&apos;ve sent a confirmation link to <strong style={{ color: '#fff' }}>{email}</strong>.<br />
            ...
            <>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 rounded-xl py-3 mb-6 font-semibold text-sm transition-all duration-200 hover:opacity-90"
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      style={{ color: 'rgba(255,255,255,0.35)', background: 'none', border: 'none', cursor: 'pointer', padding: '4px' }}
                    >
                      {showPassword ? (
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="btn-primary w-full py-3.5 text-sm font-bold rounded-xl mt-1"
              ...
              <p className="text-center mt-6 text-sm" style={{ color: 'rgba(255,255,255,0.4)' }}>
                ...
                <Link href="/auth/login" style={{ color: '#FF6B1A', fontWeight: 600 }}>
                  Sign in →
                </Link>
              </p>
            </>
