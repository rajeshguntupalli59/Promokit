      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="rounded-2xl p-8" style={{ background: '#111', border: '1px solid rgba(255,255,255,0.08)', boxShadow: '0 40px 120px rgba(0,0,0,0.6)' }}>
          <div className="mb-8 text-center">
            ...
            <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: '15px' }}>Sign in to your PromoKit account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="/auth/forgot-password" style={{ color: '#FF6B1A', fontSize: '13px', fontWeight: 500 }}>Forgot password?</Link>
              </div>
              <div className="relative">
                <input type={showPassword ? 'text' : 'password'} className="form-input" placeholder="••••••••" value={password} onChange={e => setPassword(e.target.value)} required autoComplete="current-password" style={{ paddingRight: '48px' }} />
          ...
          <p className="text-center mt-6 text-sm" style={{ color: 'rgba(255,255,255,0.4)' }}>
            Don&apos;t have an account?{' '}<Link href="/auth/signup" style={{ color: '#FF6B1A', fontWeight: 600 }}>Start free →</Link>
          </p>
        </div>
      </div>
    </div>
